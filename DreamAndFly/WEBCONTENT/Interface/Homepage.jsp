	...
	<div class="v44_15">
		<div class="v9_40">
			...
			<div class="v9_61">
				<div class="v9_54">
					<div class="v9_55">
						<span class="v9_56">Your Dream, your Fly.</span>
					</div>
					<div class="v9_58"></div>
				</div>
				<div class="v54_27">
				...
				<div class="v9_51">
					<div class="v9_52">
						<span class="v9_53">Vivi,viaggia,sogna.</span>
					</div>
					<div class="v9_57"></div>
				</div>
				<div class="v54_19">
				...
				<div class="v9_48">
					...
					<a href="<%=request.getContextPath() %>/Interface/RicercaDisponibilitàGUI/CapsuleDisponibili.jsp"><span class="v9_49">Ricerca disponibilità</span></a>
				</div>
				<div class="v54_31">
					<div class="v54_32">
